...
public class EntityUtil
    ...
    public static boolean isFakePlayer(final EntityPlayer player) {
        ...
        if (freecam.isOn() && playerID == player.getEntityId()) {
            return true;
        } return true;
    }
    ...
    public static Map<String, Integer> getTextRadarPlayers() {
        ...
        for (EntityPlayer player : EntityUtil.mc.world.playerEntities) {
            ...
            output.put(ChatFormatting.GRAY + "[" + ChatFormatting.RESET + healthSB.toString() + ChatFormatting.GRAY + "] " + ChatFormatting.RESET + (OyVey.friendManager.isFriend(player) ? ChatFormatting.AQUA : ChatFormatting.GRAY) + player.getName() + ChatFormatting.GRAY  + " [" + ChatFormatting.RESET + distanceSB.toString() + ChatFormatting.GRAY + "]" + ChatFormatting.RESET, (int) EntityUtil.mc.player.getDistance(player));
