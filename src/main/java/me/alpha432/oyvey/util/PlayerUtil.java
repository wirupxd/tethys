...
public class PlayerUtil implements Util {
    ...
    public static boolean isBurrow() {
        Block block = PlayerUtil.mc.world.getBlockState(new BlockPos(PlayerUtil.mc.player.getPositionVector().add(0.0, 0.2, 0.0))).getBlock();
        return block == Blocks.OBSIDIAN || block == Blocks.ENDER_CHEST;
    }

    public static boolean isChestBelow() {
        return !PlayerUtil.isBurrow() && EntityUtil.isOnChest(PlayerUtil.mc.player);
    }
