...
public class Replenish
    ...
    private final Setting<Integer> gapStack = this.register(new Setting<Integer>("GapStack", 1, 10, 64));
    private final Setting<Integer> xpStackAt = this.register(new Setting<Integer>("XPStack", 1, 10, 64));
