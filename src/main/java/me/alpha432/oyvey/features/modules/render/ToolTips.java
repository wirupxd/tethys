...
public class ToolTips
        extends Module {
    public Setting<Integer> posiX = this.register(new Setting<Integer>("X", 2, 0, 1000));
    public Setting<Integer> posiY = this.register(new Setting<Integer>("Y", 120, 0, 1000));
    ...
    public ToolTips() {
        super("ShulkerViewer", "Several tweaks for tooltips.", Category.RENDER, true, false, false);
        this.setInstance();
    }
    ...
    public void onRender2D(Render2DEvent event) {
        ...
        int x = posiX.getValue();
        int y = posiY.getValue();
        this.textRadarY = 0;
        for (EntityPlayer player : ToolTips.mc.world.playerEntities) {
            Timer playerTimer;
