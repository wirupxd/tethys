...
public class PearlNotify extends Module {
    ...
    public void onUpdate() {
        ...
        if (closestPlayer != null && this.flag) {
            ...
            Command.sendMessage(OyVey.friendManager.isFriend(closestPlayer.getName()) ? (ChatFormatting.AQUA + "\u00A7l" + closestPlayer.getName() + ChatFormatting.RESET + " threw a pearl (" + faceing + ")") : (ChatFormatting.RED + "\u00A7l" + closestPlayer.getName() + ChatFormatting.RESET + ChatFormatting.RESET + " threw a pearl (" + faceing + ")"));
            this.flag = false;
        }
    }
}